...
public static final String MSEDGE_DRIVER_PATH = System.getProperty("user.dir") + "/src/test/resources/drivers/msedgedriver.exe";
...
public static final String CHROME_SETUP = System.getProperty ("webdriver.http.factory", "jdk-http-client");
